...
for i in range(len(v_array)):
    ...
    cd_results.append([v_inf, cd_total, cd_duct, cd_pylon, cd_support, cd_control, cd_nacelle, cd_prop])
    ...
    eta_prop_duuc = propulsive_efficiency(fx_duuc, v_inf, power_in_duuc)
    eta_prop_ref = propulsive_efficiency(fx_ref, v_inf, power_in_ref)

    eta_prop_results.append([v_inf, eta_prop_duuc, eta_prop_ref])
